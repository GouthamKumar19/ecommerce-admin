  ...
  return (     
    <>       
      ...
      <form onSubmit={handleSubmit} className="space-y-4">             
        ...
        <div className="flex items-center ml-0.1"> {/* Shifted checkbox slightly right */}
          <label htmlFor="remember-me" className="flex items-center cursor-pointer space-x-2">
            <input 
              type="checkbox" 
              id="remember-me" 
              checked={rememberMe} 
      ...
      <div className="text-center mt-4">           
        ...
        <p className="text-sm text-[var(--secondary-color)] mt-1">Or continue with</p>           
