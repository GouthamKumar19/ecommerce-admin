        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-2 py-1">
            ...
            <div className="w-full border border-gray-300 p-3 rounded-md bg-gray-50 h-20">
              <div className="text-sm text-gray-700 leading-tight">
                <p className="font-normal">
                  {order.shippingAddressDetails.line1},{" "}
                  {order.shippingAddressDetails.line2},{" "}
          ...
          <div>
            ...
            <div className="w-full border border-gray-300 p-3 rounded-md bg-gray-50 h-20">
              <div className="text-sm text-gray-700 leading-tight">
                <p className="font-normal">
                  {order.billingAddressDetails.line1},{" "}
                  {order.billingAddressDetails.line2},{" "}
                  {order.billingAddressDetails.city},{" "}
                  {order.billingAddressDetails.state},{" "}
                  {order.billingAddressDetails.pinCode}
                </p>
              </div>
            </div>
          </div>
